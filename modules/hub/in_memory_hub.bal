...
const ALL_TOPIC = "http://projzone.com/so2w/Connectors/events/all.json";
const BUGS_TOPIC = "http://projzone.com/so2w/Connectors/events/bugs.json";
const IMPROVEMENTS_TOPIC = "http://projzone.com/so2w/Connectors/events/improvements.json";
const FEATURE_REQUESTS_TOPIC = "http://projzone.com/so2w/Connectors/events/featurerequests.json";
